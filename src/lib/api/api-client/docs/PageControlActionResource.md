...
**content** | [**Array&lt;ControlActionResource&gt;**](ControlActionResource.md) |  | [optional] [default to undefined]
...
```typescript
import { PageControlActionResource } from './api';

const instance: PageControlActionResource = {
    totalElements,
    totalPages,
    size,
    content,
